	  ...
	  for (var i in icons) {
		  $list.append('<li data-icon="'+icons[i]+'"><a href="#" title="'+icons[i]+'"><span class="'+options[0]+' '+options[1]+'-'+icons[i]+'"></span></a></li>');
				...
				$('a', $list).click(function(e) {
					...
					$('[name="' + $target + '"]' ).val(options[0]+"|"+options[1]+"-"+title);
			...
			function createPopup($button) {
				$target = $button.prev('input').attr('name');
				...
				$control.html('<p>Select Font: <select><option value="fa">Font Awesome</option><option value="dashicons">Dashicons</option></select></p>'+
