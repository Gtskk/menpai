...
class Tweets_Widget extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array('classname' => 'twitter-widget', 'description' => __( 'Display latest Tweets from Twitter.', 'presslayer' ) );
        parent::__construct('tweets-widget', __( '&raquo; Tweets', 'presslayer' ), $widget_ops);
    }
...
add_action( 'widgets_init', create_function( '', "register_widget('Tweets_Widget');" ) );
