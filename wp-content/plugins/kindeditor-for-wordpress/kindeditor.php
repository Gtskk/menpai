...
function kindeditor_option_page()
{
    ...
    <div class="wrap">
        ...
        <form action="" method="post" id="kindeditor-options-form">
            ...
            <input type="checkbox" id="ke_highlight" name="ke_highlight" <?php echo isset($checked) ? $checked : '';?> value="yes" />
            </p>
            <p>
                高亮样式：
                <select name="ke_highlight_type">
                    <option value="prettify" <?php echo isset($prettify) ? $prettify : ''; ?>>Default</option>
                    <option value="desert" <?php echo isset($desert) ? $desert : ''; ?>>Desert</option>
                    <option value="obsidian" <?php echo isset($obsidian) ? $obsidian : ''; ?>>Obsidian</option>
                    <option value="sunburst" <?php echo isset($sunburst) ? $sunburst : ''; ?>>Sunburst</option>
                </select>
            </p>
